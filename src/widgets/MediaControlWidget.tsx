  ...
  if (!is_active) {
    return (
      <div className="flex flex-col items-center justify-center h-64 gap-3 text-center">
        <p className="text-gray-400">No active playback detected.</p>
        <p className="text-sm text-gray-500">Start playing on any Spotify device to see controls.</p>
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="flex items-center justify-center gap-8">
        <button
          ...
          className="text-gray-300 hover:text-white transition-colors active:scale-95"
        >
          <SkipBack size={32} />
        </button>
